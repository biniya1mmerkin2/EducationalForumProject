...
export default function UserCard(props){
    return(
                <Paper sx={{padding:'10px', marginTop:3, color:'white', backgroundColor:'black', border:'1px solid rgba(240, 248, 255, 0.715)', width:'250px'}}>
                    <Box sx={{float:'right'}}>
                    ...
                    />
                        ...
                        <Button variant="contained" size='small'sx={{backgroundColor:'#ec5218', width:'30px', borderRadius:'0px', width:'75%', color:'black', fontSize:'large', fontWeight:'400'}}>Follow</Button>
